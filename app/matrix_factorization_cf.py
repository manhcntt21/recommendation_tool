...
ratings_base = pd.read_csv('./data/recommendation_systems/ml-100k/ub.base', sep='\t',
                           names=r_cols, encoding='latin-1')
ratings_test = pd.read_csv('./data/recommendation_systems/ml-100k/ub.test', sep='\t',
                           names=r_cols, encoding='latin-1')
